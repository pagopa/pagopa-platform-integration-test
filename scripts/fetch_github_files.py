...
def _build_runtime_secrets() -> dict:
    ...
    # Load settings and secrets from the integration config folder.
    # This is the same logic used by Behave when running the WISP suite.
    configurations = load_configurations(SCRIPT_DIR)
