Feature: Checkout Payment Activation
  ...
  Scenario Outline: Should correctly execute a payment with card configuration "<testingPsp>"
    ...
    Examples:
      ...
      | Worldpay   | 302              | 77777777777 | test@test.com | 4111111111111111 | 12/30          | 123 | psp-001 |
  ...
  Scenario Outline: Should throw error <errorCode> for invalid notice code in range <rangeStart>-<rangeEnd>
    ...
    Examples:
      ...
      | PAA_PAGAMENTO_SCONOSCIUTO      | 302400000000000000   | 302409999999999999   | 77777777777 | Non riusciamo a trovare l’avviso                       | L’avviso potrebbe essere stato già pagato. Per ricevere assistenza, contatta l’Ente Creditore. |
      | PAA_PAGAMENTO_SCADUTO          | 302990000000000000   | 302999999999999999   | 77777777777 | L’avviso è scaduto e non è più possibile pagarlo       | Contatta l’Ente per maggiori informazioni.                                                |
      | PPT_STAZIONE_INT_PA_TIMEOUT    | 302980000000000000   | 302989999999999999   | 77777777777 | Si è verificato un errore imprevisto                   | Riprova, oppure contatta l’assistenza                                                     |
      | PAA_PAGAMENTO_DUPLICATO        | 302950100443009424   | 302950100443009424   | 77777777777 | Questo avviso è stato già pagato!                      |                                                                                           |
