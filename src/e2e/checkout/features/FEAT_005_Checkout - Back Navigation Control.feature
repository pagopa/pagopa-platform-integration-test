...
Scenario: Navigazione - Selezione CTA Inserisci i tuoi dati
  Dato L’utente si trova sulla HP di Checkout
  Quando L’utente clicca sulla CTA “Inserisci i tuoi dati”
...
Scenario: Navigazione - Conferma pagina di riepilogo
  ...
  Quando L’utente clicca sulla CTA “Vai al pagamento”
...
Scenario: Navigazione - Inserimento email
  ...
  Quando L’utente clicca sulla CTA Continua
...
Scenario: Navigazione - Scelta metodo di pagamento “Carte di Credito”
  ...
  Quando L’utente clicca sulla CTA Carte di Credito
...
Scenario: Assenza loop di navigazione per indietro successivi da pagina Modifica metodo di pagamento
  ...
  Quando L’utente clicca ripetutamente il tasto Indietro
