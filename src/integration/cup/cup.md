feature file per cup.
path: `src/integration/cup/creazione_posizione_debitoria.feature`
```gherkin
# language: it
@FEAT_001_CUP_Creazione di una posizione debitoria per CUP
...
@negativo
@FEAT_001_CUP_scenario_02
Scenario Outline: Valorizzazione di più parametri identificativi 
...
@negativo
@FEAT_001_CUP_scenario_03
Scenario Outline:  Il dato fornito (CF, ISTAT o Catastale) non rispetta il formato sintattico previsto
...
@negativo
@FEAT_001_CUP_scenario_04
Scenario Outline:  Mancanza di uno o più parametri obbligatori 
...
@negativo
@FEAT_001_CUP_scenario_05
Scenario Outline:  Formato dei campi amount o debtorFiscalCode non valido
...
@negativo
@FEAT_001_CUP_scenario_06
Scenario Outline:  La chiave di ricerca fornita (CF, ISTAT o Catastale) non è presente in cache
...
## Esempio curl di chiamata a mock demandPaymentNotice per CUP happy path##
```bash
curl --location 'https://api.dev.platform.pagopa.it/mock-ec-primary/service/v1/mock' \
...
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:pafn="http://pagopa-api.pagopa.gov.it/pa/paForNode.xsd">
  <soapenv:Body>
    <pafn:paDemandPaymentNoticeRequest>
      <idPA>01234567890</idPA>
      <idBrokerPA>GPS_BROKER_ID</idBrokerPA>
      <idStation>GPS_STATION_ID</idStation>
      <idServizio>CUP</idServizio>
      <datiSpecificiServizioRequest>
        <cupRequest>
          <organizationFiscalCode>01234567890</organizationFiscalCode>
          <debtorFiscalCode>00588460050</debtorFiscalCode>
          <debtorFullName>TIM S.p.A.</debtorFullName>
          <debtorEmail>amministrazione@tim.it</debtorEmail>
          <companyName>TIM</companyName>
          <amount>80.00</amount>
         </cupRequest>
      </datiSpecificiServizioRequest>
    </pafn:paDemandPaymentNoticeRequest>
...
** Valorizzazione di più parametri identificativi :**
...
```
** Il dato fornito (CF, ISTAT o Catastale) non rispetta il formato sintattico previsto:**
```xml
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:pafn="http://pagopa-api.pagopa.gov.it/pa/paForNode.xsd">
  <soapenv:Body>
    <pafn:paDemandPaymentNoticeRequest>
      ...
      <datiSpecificiServizioRequest>
        <cupRequest>
          <organizationFiscalCode>ABC12!</organizationFiscalCode>
          <debtorFiscalCode>00588460050</debtorFiscalCode>
          <debtorFullName>TIM S.p.A.</debtorFullName>
          <debtorEmail>amministrazione@tim.it</debtorEmail>
          <companyName>TIM</companyName>
...
```
** Mancanza di uno o più campi obbligatori: **
```xml
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:pafn="http://pagopa-api.pagopa.gov.it/pa/paForNode.xsd">
  <soapenv:Body>
    <pafn:paDemandPaymentNoticeRequest>
...
```
** Formato dei campi amount o debtorFiscalCode non valido.: **
```xml
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:pafn="http://pagopa-api.pagopa.gov.it/pa/paForNode.xsd">
  <soapenv:Body>
    <pafn:paDemandPaymentNoticeRequest>
      ...
      <datiSpecificiServizioRequest>
        <cupRequest>
          <organizationFiscalCode>01234567890</organizationFiscalCode>
          <debtorFiscalCode>ABCDEF123</debtorFiscalCode>
          <debtorFullName>TIM S.p.A.</debtorFullName>
          <debtorEmail>amministrazione@tim.it</debtorEmail>
          <companyName>TIM</companyName>
          <amount>ottanta</amount>
         </cupRequest>
      </datiSpecificiServizioRequest>
    </pafn:paDemandPaymentNoticeRequest>
  </soapenv:Body>
...
### La chiave di ricerca fornita (CF, ISTAT o Catastale) non è presente in cache: ###
** istat **
```xml
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:pafn="http://pagopa-api.pagopa.gov.it/pa/paForNode.xsd">
  <soapenv:Body>
...
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:pafn="http://pagopa-api.pagopa.gov.it/pa/paForNode.xsd">
  <soapenv:Body>
    <pafn:paDemandPaymentNoticeRequest>
      ...
      <datiSpecificiServizioRequest>
        <cupRequest>
          <organizationFiscalcode>noCache</organizationFiscalcode>
          <debtorFiscalCode>00588460050</debtorFiscalCode>
          <debtorFullName>TIM S.p.A.</debtorFullName>
          <debtorEmail>amministrazione@tim.it</debtorEmail>
          <companyName>TIM</companyName>
...
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:pafn="http://pagopa-api.pagopa.gov.it/pa/paForNode.xsd">
  <soapenv:Body>
    <pafn:paDemandPaymentNoticeRequest>
      ...
      <datiSpecificiServizioRequest>
        <cupRequest>
          <catastalCode>noCache</catastalCode>
          <debtorFiscalCode>00588460050</debtorFiscalCode>
          <debtorFullName>TIM S.p.A.</debtorFullName>
          <debtorEmail>amministrazione@tim.it</debtorEmail>
          <companyName>TIM</companyName>
