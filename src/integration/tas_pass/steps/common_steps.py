"""Shared Given and When step definitions for the tas_pass demo suite.

All steps are no-ops: they succeed instantly without performing any real operation.
This suite is intended for TAS demonstrations where a fully green run is needed.
"""
import logging
